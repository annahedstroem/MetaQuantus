...
def setup_example_estimators(
    ...
    return setup_randomisation_estimators(features=features,
...
if __name__ == "__main__":
    ...
    # Get estimators.
    estimators = setup_example_estimators(
    ...
    xai_setting = ["Gradient", "GradCAM", "Occlusion"]
